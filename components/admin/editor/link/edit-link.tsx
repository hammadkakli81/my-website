...
const EditLink: FC<Props> = ({ editor }) => {
  ...
  return (
    <BubbleMenu
      ...
      editor={editor}
      tippyOptions={{ onHide: () => setShowEditForm(false) }}
    >
      <LinkForm
      ...
      />
      {!showEditForm && (
        <div className="bg-primary text-primary-dark shadow-secondary-dark dark:bg-primary-dark dark:text-primary z-50 flex items-center space-x-6 rounded p-3 shadow-md">
