...
const EmbedYoutube: FC<Props> = ({ onSubmit }) => {
  ...
  return (
    ...
    >
      ...
      {showYoutubeForm && (
        <div className="absolute right-0 top-full z-20 mt-4">
          <div className="flex space-x-2">
            <input
              ...
              className="border-secondary-dark outline-none bg-[#283045] text-primary-dark focus:border-primary-dark dark:text-primary dark:focus:border-primary rounded border-2 bg-transparent p-2 transition"
            />
            <button
